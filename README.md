...
| --- | --- | --- |
| [Recall](./examples/recall/README.md) | Which customers with shipped orders of the recalled product still need an exchange-contact ticket? Compare ERP orders with support tickets, then create the missing tickets in support. | `pnpm demo:recall` |
